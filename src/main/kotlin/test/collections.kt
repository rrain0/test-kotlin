...
fun collections(){
    ...
    run {
        ...
        val readonlyMap = mapOf("one" to 1, "two" to 2, "ten" to 10)
        val mutableMap = mutableMapOf("one" to 1, "two" to 2, "ten" to 10)
        ...
        if (readonlyMap.containsValue(1)) println("The value 1 is in the map") // same as previous
    }
