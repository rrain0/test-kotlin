package kotlinlang.`builder-pattern`
...
private data class Source private constructor(
  val paths: List<Path>, val readThreadId: Any, val tag: Any?
) {
  constructor(paths: List<Path>, readThreadId: Any?, tag: Any?, second: Boolean = true) : this(
    paths.toList(), readThreadId ?: Object(), tag
  )
