package kotlinlang.multithreading.multithreading
...
private fun testReentrantLock(){
  ...
  // Можно блокировать одним потоком несколько раз,
  // но нужно разблокировать ровно столько же раз.

  // Note that withLock is a Kotlin-provided extension function
  // that takes care of calling Lock.lock() / Lock.unlock() before / after invoking
  // the supplied lambda.
