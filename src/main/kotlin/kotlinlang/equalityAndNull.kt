...
private fun nulls() {
  ...
  // ?. - доступ к свойству, если объект не null
  list2?.toSet() // если != null, тогда функция на объекте выполнится
  // !! - утверждение, что не null. Если окажется null, то выкинется exception.
...
private fun floatNumberEquality() {
  /*
    ...
    то используются реализации equals и compareTo для Float и Double,
